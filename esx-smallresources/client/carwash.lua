...
RegisterNetEvent('qb-carwash:client:washCar', function()
    ...
    washingVehicle = true
    exports['progressBars']:startUI("search_cabin", "Vehicle is being washed ..", math.random(4000, 8000), false, true, {
        ...
        TriggerEvent("esx:showNotification", "Washing canceled ..", "error")
        washingVehicle = false
    end)
                            ...
                            if not washingVehicle then
                                ...
                                if IsControlJustPressed(0, 38) then
                                    if dirtLevel > Config.DirtLevel then
                                        ...
                                        TriggerEvent("esx:showNotification", "The vehicle isn't dirty", "error")
                                    end
                                end
                            else
